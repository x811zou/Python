...
out2 = out_path+"model_med_%s/"%(sys.argv[6])+str(outfix)+"_s-"+str(sigma)+".pickle"
out3 = out_path+"model_prob_%s/"%(sys.argv[6])+str(outfix)+"_s-"+str(sigma)+".pickle"
out4 = out_path+"model_prob2_%s/"%(sys.argv[6])+str(outfix)+"_s-"+str(sigma)+".pickle"
